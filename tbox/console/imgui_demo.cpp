...
static me::Tracer*  ShowVehicleAppConsole(bool* p_open, bool draw, char* (*getf)(int), void(*func)(char*));
...
struct ExampleAppConsole : public me::Tracer
{
    char                  InputBuf[256];
    ImVector<char*>       Items;
    bool                  ScrollToBottom;
	...
	virtual me::b32 outputString(const char* str) {
    ...
    void    Draw(const char* title, bool* p_open,char* (getf)(int),void (func)(char*))
    {
		...
		if (ImGui::SmallButton(" v ")) { func("v"); } ImGui::SameLine();
		if (ImGui::SmallButton(" i ")) { func("i"); } ImGui::SameLine();
		if (ImGui::SmallButton(" m ")) { func("m"); } ImGui::SameLine();
		if (ImGui::SmallButton(" w ")) { func("w"); } ImGui::SameLine();
		if (ImGui::SmallButton(" e ")) { func("e"); } ImGui::Separator();

		if (ImGui::SmallButton(" 1 ")) { func("MAXIMUM"); } ImGui::SameLine();
		if (ImGui::SmallButton(" 2 ")) { func("MEDIUM"); } ImGui::SameLine();
		if (ImGui::SmallButton(" 3 ")) { func("MINIMUM"); } ImGui::SameLine();
		if (ImGui::SmallButton(" 4 ")) { func("PROTOCOL"); } ImGui::SameLine();
		if (ImGui::SmallButton(" 5 ")) { func("ERROR"); } ImGui::Separator();

		ImGui::Text("Event :");ImGui::SameLine();
		if (ImGui::SmallButton("netOk")) { func("me.netOk();"); } ImGui::SameLine();
		if (ImGui::SmallButton("netFail")) { func("me.netFail();"); }  ImGui::Separator();

		ImGui::Text("Mqtt  :");ImGui::SameLine();
...
struct VehicleConsole : public me::Tracer
{
	char                  InputBuf[256];
	ImVector<char*>       Items;
	bool                  ScrollToBottom;
...
static me::Tracer* ShowVehicleAppConsole(bool* p_open, bool draw, char* (getf)(int), void (func)(char*))
{
	static VehicleConsole console;
	if (draw)console.Draw("Example: Vehicle", p_open, getf, func);
	return &console;
}
