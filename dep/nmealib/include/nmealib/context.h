...
#define __ATTR_FMT_12
#else
#define __ATTR_FMT_12 __attribute__((format(printf, 1, 2)))
#endif
 ...
 */
void nmeaContextTrace(const char *s, ...) __ATTR_FMT_12;
 ...
 */
void nmeaContextError(const char *s, ...) __ATTR_FMT_12;
